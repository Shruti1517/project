...
const appRoutes: Routes = [
  ...
  { path: 'account-recovery/:id',component:AccountRecoveryComponent},
      ...
      [
        {
          ...
          provider: new GoogleLoginProvider("426674725413-md5jfu5r6a4tqnkbuq5r4b5jupr6pjo9.apps.googleusercontent.com")
        },
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot(appRoutes),NgbModule,ImageCropperModule,
   BrowserAnimationsModule,SocialLoginModule,NgxScrollToFirstInvalidModule,
   DataTableModule,AutocompleteLibModule,NgxPaginationModule,
